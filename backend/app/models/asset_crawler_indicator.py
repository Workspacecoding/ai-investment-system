...
class AssetCrawlerIndicator(Base):
    __tablename__ = "asset_crawler_indicators"
    __table_args__ = (
        UniqueConstraint("asset_id", "indicator_id", name="uq_asset_crawler_indicator"),
    )
    ...
    indicator_type = Column(String(30), nullable=True)   # fundamental / technical / chips
    api_source_id = Column(BigInteger, nullable=True)    # FK to api_configs
    ...
    crawl_time = Column(String(50), nullable=True)       # HH:MM or cron expression
