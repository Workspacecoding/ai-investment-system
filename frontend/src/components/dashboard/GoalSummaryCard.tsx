      ...
      <CardHeader>
        <div className="flex items-start justify-between gap-3">
          <div>
            ...
            <CardDescription>目標進度與成功機率</CardDescription>
          </div>
          <Link
        ...
        {!goal ? (
          ...
          <>
            ...
            <div className="grid gap-3 sm:grid-cols-2">
              <Metric label="Current Capital" value={formatMoney(goal.current_capital)} />
              <Metric label="Target Capital" value={formatMoney(goal.target_capital)} />
              <Metric label="Probability Score" value={formatPercent(goal.probability_score)} />
            </div>
          </>
        )}
      </CardContent>
